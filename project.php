	...
	<body>
		...
		<article id="top">
			<section id="coldfusion">
				...
				<p><figure class="logos"><a href="#" target="_blank"><img src="img/jrproperties-logo.png" alt="J&R Properties logo"/></a></figure>This site was my capstone project at school.We were tasked with going out and finding a customer, and then redesign/ceate a website. We had to come up with different documents like an ERD, Gantt chart, project proposal, etc. I was the lead designer/developer fo the project, so I was in charge of creating a logo and building and programming the site. The site was originally created using ColdFusion, but we will be translating it to PHP for security purposes. The code is being listed on my GitHub, so <a href="https://github.com/evanmcc92/JR-Properties-cf" target="_blank">feel free to take a look</a>.</p>
				</div>
			</section>
			...
			<section id="objective-c">
				...
				<p><figure class="logos"><a href="http://wp.me/p3Hzyo-q" target="_blank"><img src="img/app-logo.png" alt="First iPhone App logo"/></a></figure>I successfully created an iOS app using Objective-C and XCode. This app is an iPhone and iPod Touch friendly version of this current site. I am not planning on putting it onto the App Store because I am not currently enrolled in Apple's developer programs. I am, however, providing the screenshots to show what it looks like and how it behaves.</p>
				</div>
				<div>
				<h4><a href="https://github.com/evanmcc92/Emily-Massage-Kit" target="_blank">Massage Counter</a></h4>
				<p><figure class="logos"><a href="https://github.com/evanmcc92/Emily-Massage-Kit" target="_blank"><img src="img/massage-app-logo.png" alt="Massage Counter logo"/></a></figure>The next iPhone app I created was something for my girlfriend in order to count massages given (I know it's pretty lame). But this app was more complex that the first app. It required more coding and took a lot longer to develop. Again, I am not enrolled in any developer programs but I have managed to upload the code to GitHub so if you are interested <a href="https://github.com/evanmcc92/Emily-Massage-Kit" target="_blank">feel free to take a look</a>.</p>
				</div>
			</section>
			...
			<section id="rails">
				...
				<div>
					...
					<p><figure class="logos"><a href="http://rails-app-v1.herokuapp.com/" target="_blank"><img src="img/ruby.png" alt="Rails Blog logo"/></a></figure>This is the first app I created using Ruby on Rails. I followed along with a tutorial for Ruby beginners and I am very pleased with the outcome. I have been recently working with making the layout to be more dynamic and appealing along with adding more features. The code has been uploaded to <a href="https://github.com/evanmcc92/rails-app-v1" target="_blank">GitHub</a> and will continue to work on this as time goes on.</p>
				</div>

				<div>
					<h4><a href="http://just-sayin.herokuapp.com/" target="_blank">JustSayin</a></h4>
					<p><figure class="logos"><a href="http://just-sayin.herokuapp.com/" target="_blank"><img src="img/justsayin-logo.png" alt="JustSayin logo"/></a></figure>JustSayin is a rails based social media platform I created from September to December of 2013. The app is hosted on Heroku and is running Ruby 2.0.0, Ruby on Rails 4, and PostgreSQL in production. <a href="https://github.com/evanmcc92/JustSayin" target="_blank">Feel free to take a look at the code hosted on my GitHub</a>. I have more details about what the app does and my feelings about it on my <a href="http://wp.me/p3Hzyo-1z" target="_blank">blog here</a>.</p>
				</div>

				<div>
					<h4><a href="http://evan-wiki.herokuapp.com/" target="_blank">Wiki</a></h4>
					<p><figure class="logos"><a href="http://evan-wiki.herokuapp.com/" target="_blank"><img src="img/wiki.png" alt="Wiki logo"/></a></figure>JustSayin is a rails based social media platform I created from September to December of 2013. The app is hosted on Heroku and is running Ruby 2.0.0, Ruby on Rails 4, and PostgreSQL in production. Feel free to take a look at the code hosted on my GitHub. I have more details about what the app does and my feelings about it on my blog here.</p>
				</div>

				<div>
					<h4><a href="http://to-do-em.herokuapp.com/" target="_blank">Task Manager</a></h4>
					<p><figure class="logos"><a href="http://to-do-em.herokuapp.com/" target="_blank"><img src="img/todo-logo.png" alt="Task Manager logo"/></a></figure>JustSayin is a rails based social media platform I created from September to December of 2013. The app is hosted on Heroku and is running Ruby 2.0.0, Ruby on Rails 4, and PostgreSQL in production. Feel free to take a look at the code hosted on my GitHub. I have more details about what the app does and my feelings about it on my blog here.</p>
				</div>
			</section>
